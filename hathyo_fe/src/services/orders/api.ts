...
export async function orders(
  ...
  const response = await request<API.OrdersResponse>('/orders', {
    method: 'GET',
    baseURL: ADMIN_API_URL as string,
    params: {
      ...params,
...
export async function ordersRevenue(
  ...
  const response = await request<API.RevenueSummary>('/orders/revenue', {
    method: 'POST',
    baseURL: ADMIN_API_URL as string,
    data: {
      ...body,
...
export async function transOrders(body: API.OrderTransRequest, options?: { [key: string]: any }) {
  const response = await request<any>(`/orders/${body.id}/trans`, {
    method: 'PATCH',
    baseURL: ADMIN_API_URL as string,
    data: {
...
export async function cancelOrders(body: API.OrderCancelRequest, options?: { [key: string]: any }) {
  const response = await request<any>(`/orders/${body.id}/cancel`, {
    method: 'PATCH',
    baseURL: ADMIN_API_URL as string,
    data: {

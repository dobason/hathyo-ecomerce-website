    ...
    <main>
      <div className="container m-auto">
        <div className="flex flex-col justify-center items-center">
          <div className="xl:xl:w-3/4 flex my-5 justify-center text-center">
            <div className="heading-3 text-Moss/700">
              Tích lũy Hathyo Calorie
            </div>
          </div>
          <div className="xl:w-3/4 flex flex-row my-5 justify-center">
            <Image
              className="xl:w-3/4 h-3/4 object-cover"
              alt="main banner"
              src="/update.svg"
              width="600"
              height="600"

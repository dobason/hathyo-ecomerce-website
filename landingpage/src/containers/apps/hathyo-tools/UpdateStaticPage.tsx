...
function UpdateStaticPage({ setTool }: Prop) {
  return (
    <main>
      <div className="container m-auto">
        ...
        <div className="flex justify-center xl:m-10 xl:gap-5 m-2 gap-2">
          ...
          <Button>
            <div
              className="flex justify-center items-center gap-2 body-semibold text-Moss/500"
              onClick={() => {
                setTool(null);
              }}
            >
              <p className="body-sm-medium">Trở lại</p>
            </div>
          </Button>
        </div>
      </div>
